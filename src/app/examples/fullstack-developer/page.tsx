...
import { fullstackDeveloperData } from '../../../../examples/fullstack-developer';
import { Container } from '@/components/layout';

export const metadata: Metadata = {
    title: 'Full Stack Developer Example - Michael Rodriguez',
    description: 'Portfolio configuration example for a full stack developer with expertise in both frontend and backend technologies.',
};

export default function FullstackDeveloperPage() {
    const data = fullstackDeveloperData;
            ...
            <Container size='md' className='py-8 sm:py-12'>
                ...
                <div className="grid gap-8 lg:grid-cols-3">
                    <div className="lg:col-span-2">
                        ...
                        <div className="mb-8">
                            <h2 className="text-xl font-semibold text-foreground mb-4">Key Strengths</h2>
