...
import { frontendDeveloperData } from '../../../../examples/frontend-developer';
import { Container } from '@/components/layout';

export const metadata: Metadata = {
    title: 'Frontend Developer Example - Sarah Chen',
    description: 'Portfolio configuration example for a frontend developer specializing in React, Vue.js, and modern web technologies.',
};

export default function FrontendDeveloperPage() {
    const data = frontendDeveloperData;
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="mb-8">
                            ...
                            <div className="space-y-4">
                                {['frontend', 'design', 'devops', 'other'].map((category) => {
                                    ...
                                    return (
                                        <div key={category}>
                                            <h3 className="text-sm font-medium text-foreground mb-2 capitalize">
                                                {category === 'devops' ? 'DevOps & Build Tools' : category}
                                            </h3>
